...
var _forgotPasswordJs = require("./forgotPassword.js");
var _forgotPasswordJsDefault = parcelHelpers.interopDefault(_forgotPasswordJs);
var _resetPasswordJs = require("./resetPassword.js");
var _resetPasswordJsDefault = parcelHelpers.interopDefault(_resetPasswordJs);
...
var _reviewJsDefault = parcelHelpers.interopDefault(_reviewJs);
var _axios = require("axios");
var _axiosDefault = parcelHelpers.interopDefault(_axios);
var _ratingComponentJs = require("./ratingComponent.js");
var _ratingComponentJsDefault = parcelHelpers.interopDefault(_ratingComponentJs);
var _editReviewModalJs = require("../../views/modals/editReviewModal.js");
var _editReviewModalJsDefault = parcelHelpers.interopDefault(_editReviewModalJs);
// ELEMENTS
...
if (loginForm) loginForm.addEventListener("submit", (e)=>{
    ...
    (0, _loginJsDefault.default)(email, password);
});
if (logoutBtn) logoutBtn.addEventListener("click", (e)=>{
    e.preventDefault();
    (0, _logoutJsDefault.default)();
});
if (updateProfileInfoForm) {
    ...
    updateProfileInfoForm.addEventListener("submit", (e)=>{
        ...
        (0, _updateProfileJsDefault.default)(formData, "info");
    });
}
if (updatePasswordForm) updatePasswordForm.addEventListener("submit", async (e)=>{
    ...
    await (0, _updateProfileJsDefault.default)({
...
if (bookTourBtn) {
    ...
    bookTourBtn.addEventListener("click", (e)=>{
        ...
        if (!tourId) return;
        (0, _stripeJsDefault.default)(tourId, startDate);
    });
}
if (googleBtn) googleBtn.addEventListener("click", (e)=>{
    e.preventDefault();
    (0, _googleJsDefault.default)();
});
if (forgotPasswordForm) {
    ...
    forgotPasswordBtn.addEventListener("click", async (e)=>{
        ...
        await (0, _forgotPasswordJsDefault.default)(email);
...
if (resetPasswordForm) {
    ...
    resetPasswordForm.addEventListener("submit", async (e)=>{
        e.preventDefault();
        const newPassword = document.querySelector('.reset-password-form input[name="password"]').value;
        const confirmPassword = document.querySelector('.reset-password-form input[name="confirmPassword"]').value;
        const resetToken = resetPasswordForm.dataset.resetToken;
        console.log(resetToken);
        resetPasswordBtn.disabled = true;
        resetPasswordBtn.textContent = "Resetting...";
        await (0, _resetPasswordJsDefault.default)(newPassword, confirmPassword, resetToken);
...
if (signupForm) signupForm.addEventListener("submit", async (e)=>{
    ...
    await (0, _signupJsDefault.default)(name, email, password, confirmPassword);
});
if (reviewForm) {
    ...
    //   // });
    // });
    (0, _ratingComponentJsDefault.default)("rating");
    reviewForm.addEventListener("submit", async (e)=>{
        e.preventDefault();
        const rating = document.querySelectorAll(".rating .reviews__star--active").length;
        const content = document.getElementById("reviewInput").value;
        const { tourId } = reviewForm.dataset;
        await (0, _reviewJsDefault.default)(tourId, content, rating);
    });
}
// global modal
...
if (reviewItems && reviewItems.length !== 0) reviewItems.forEach((review, idx)=>{
    ...
    editButton.addEventListener("click", async (e)=>{
        ...
        openModal((0, _editReviewModalJsDefault.default)(reviewData));
        // Sau khi mở edit review modal
        const editReviewModal = document.querySelector(".edit-review-modal");
        (0, _ratingComponentJsDefault.default)("edit-review-modal");
        const editReviewForm = editReviewModal.querySelector(".review-form");
        editReviewForm.addEventListener("submit", async (e)=>{
            e.preventDefault();
            // Update database
            const reviewContent = editReviewForm.querySelector("#reviewInput").value;
            const rating = editReviewForm.querySelectorAll(".reviews__star--active").length;
            const res = await (0, _axiosDefault.default)({
                url: `/api/reviews/${reviewId}`,
                method: "PATCH",
                data: {
...
},{"./map.js":"GDuAq","./login.js":"7yHem","./logout.js":"1ftRF","./updateProfile.js":"gjLaR","./stripe.js":"10tSC","./google.js":"ivM3w","./forgotPassword.js":"4l6TW","./resetPassword.js":"eRWSh","@parcel/transformer-js/src/esmodule-helpers.js":"gkKU3","./signup.js":"fNY2o","./review.js":"9Gbth","axios":"jo6P5","../../views/modals/editReviewModal.js":"8CYMM","./ratingComponent.js":"4JKyv"}],"GDuAq":[function(require,module,exports) {
...
},{"axios":"jo6P5","@parcel/transformer-js/src/esmodule-helpers.js":"gkKU3"}],"gjLaR":[function(require,module,exports) {
var parcelHelpers = require("@parcel/transformer-js/src/esmodule-helpers.js");
parcelHelpers.defineInteropFlag(exports);
var _axios = require("axios");
var _axiosDefault = parcelHelpers.interopDefault(_axios);
...
const updateUser = async (data, type)=>{
    const url = type === "password" ? "/api/users/update-profile-password" : "/api/users/update-profile";
    try {
        const res = await (0, _axiosDefault.default)({
            url,
            method: "PATCH",
        ...
        if (res.data.status === "success") {
            (0, _alertJs.showAlert)("success", "Update successful");
            const displayer = document.querySelector(".form__user-photo");
...
},{"axios":"jo6P5","./alert.js":"kxdiQ","@parcel/transformer-js/src/esmodule-helpers.js":"gkKU3"}],"ivM3w":[function(require,module,exports) {
var parcelHelpers = require("@parcel/transformer-js/src/esmodule-helpers.js");
parcelHelpers.defineInteropFlag(exports);
var _axios = require("axios");
var _axiosDefault = parcelHelpers.interopDefault(_axios);
...
},{"axios":"jo6P5","@parcel/transformer-js/src/esmodule-helpers.js":"gkKU3"}],"4l6TW":[function(require,module,exports) {
var parcelHelpers = require("@parcel/transformer-js/src/esmodule-helpers.js");
parcelHelpers.defineInteropFlag(exports);
var _axios = require("axios");
var _axiosDefault = parcelHelpers.interopDefault(_axios);
...
const forgotPassword = async (email)=>{
    try {
        ...
        (0, _alert.showAlert)("success", "Sent successfully ! Please check your email");
    } catch (err) {
...
},{"axios":"jo6P5","./alert":"kxdiQ","@parcel/transformer-js/src/esmodule-helpers.js":"gkKU3"}],"eRWSh":[function(require,module,exports) {
var parcelHelpers = require("@parcel/transformer-js/src/esmodule-helpers.js");
parcelHelpers.defineInteropFlag(exports);
var _axios = require("axios");
var _axiosDefault = parcelHelpers.interopDefault(_axios);
...
const signup = async (name, email, password, confirmPassword)=>{
    try {
        ...
        console.log(res);
        (0, _alertJs.showAlert)("success", "Signup successful");
        setTimeout(()=>{
            location.assign("/");
        }, 500);
    } catch (err) {
...
},{"axios":"jo6P5","./alert.js":"kxdiQ","@parcel/transformer-js/src/esmodule-helpers.js":"gkKU3"}],"9Gbth":[function(require,module,exports) {
var parcelHelpers = require("@parcel/transformer-js/src/esmodule-helpers.js");
parcelHelpers.defineInteropFlag(exports);
var _axios = require("axios");
var _axiosDefault = parcelHelpers.interopDefault(_axios);
...
const review = async (tourId, content, rating)=>{
    try {
        ...
        (0, _alert.showAlert)("success", "Review successfully. Thank you !");
        // update UI
        const reviewData = res.data.data.doc;
        const reviewHTML = `
      <div class="review">
...
},{"axios":"jo6P5","@parcel/transformer-js/src/esmodule-helpers.js":"gkKU3","./alert":"kxdiQ"}],"8CYMM":[function(require,module,exports) {
var parcelHelpers = require("@parcel/transformer-js/src/esmodule-helpers.js");
parcelHelpers.defineInteropFlag(exports);
...
exports.default = generateEditReviewModalContent;

},{"@parcel/transformer-js/src/esmodule-helpers.js":"gkKU3"}],"4JKyv":[function(require,module,exports) {
var parcelHelpers = require("@parcel/transformer-js/src/esmodule-helpers.js");
parcelHelpers.defineInteropFlag(exports);
...
exports.default = ratingComponentConfig;

},{"@parcel/transformer-js/src/esmodule-helpers.js":"gkKU3"}]},["gTVKZ","f2QDv"], "f2QDv", "parcelRequire7e89")
